...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* para decirle que deshabilite los marcos, abarcando all the content */
        EdgeToEdge.enable(this);
        //setea el contenido, dentro de la carpeta R(res o resource) y dentro de la carpeta layout
        //es ahi donde setea el activity_main
